...
A stand-alone script to run these analyses is provided as `r projection.R`.  The remainder of this document explains the rationale and steps within that script in more detail.
...
```{r species_projections_run, eval = TRUE, echo = FALSE, warnings = FALSE, messages = FALSE}
