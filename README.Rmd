...
Projections are distinct from forecasts, and we are **not** making predictions about the future state a population will achieve.  Rather, we are describing a path towards recovery that is potentially achievable if conservation action is pursued.
