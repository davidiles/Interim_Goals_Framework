...
We applied the framework to _____ species that are estimated to have experienced long-term population declines and are considered to be well-monitored by the Breeding Bird Survey.  For each species, we set population goals in 2022 (the most recent year of BBS estimates).
...
3) Reporting the population status in 2050, if the population grew according to the projection
4) Reporting the year in which 'full recovery' would be achieved, if the population grew according to the projection.
