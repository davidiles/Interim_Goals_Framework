...
We start by fitting a hierarchical population model to monitoring data for a focal species; in this case **Clay-colored Sparrow**.  We accomplish this using the `bbsBayes2` R package for species monitored by the North American Breeding Bird Survey.
