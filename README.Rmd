...
for (species_name in target_species$Species){
  ...
  # Load fitted model for this species, save resulting indices
  if (file.exists(filename)){
...
Illustrations that using short-term trends could be misleading.  Short-term changes should be contextualized in terms of long-term trends.

Clay-colored Sparrow - cyclic pattern
Eastern Kingbird - recent positive trend (need for using long-term trend?)
