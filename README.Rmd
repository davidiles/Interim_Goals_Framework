...
projection_function <- function(sp_results = NULL,
  ...
  Year_of_full_Recovery <- apply(percent_of_Baseline_Recovery[,which(year_seq_projection > year_goals_are_set)],1,function(x) min(which(x >= 100)))
...
```{r species_projections_run, eval = TRUE}
```
